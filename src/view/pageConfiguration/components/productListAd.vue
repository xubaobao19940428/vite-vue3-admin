    ...
    <div class="app-container">
        <el-form inline>
            <el-form-item label="国家：">
                <el-select v-model="searchParam.countryCode" filterable clearable>
            ...
            <el-form-item label="应用平台：">
                <el-select v-model="searchParam.appType">
                    <el-option v-for="key in Object.keys(APP_TYPE)" :key="key" :label="APP_TYPE[key]" :value="parseInt(key)"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click="getList(1)" icon="el-icon-search" size="medium">查询</el-button>
            </el-form-item>
        </el-form>
        <div class="operator-container">
            <el-button size="medium" type="primary" v-if="hasPermission('BTN_PRODUCT_LIST_AD_ADD')" icon="el-icon-plus" @click="showEditDialog()">
                新增
            </el-button>
            <el-button
                size="medium"
        ...
        <div class="main-content-wrapper">
            <el-table border height="100%" :data="dataList" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="应用平台" align="center">
                    <template slot-scope="scope">{{ APP_TYPE[scope.row.appType] }}</template>
                </el-table-column>
                ...
                <el-table-column fixed="right" label="操作" align="center" min-width="140px">
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" size="mini" v-if="hasPermission('BTN_PRODUCT_LIST_AD_BATCH_DELETE')" @click="toDelete([scope.row.id])">
                            删除
                        </el-button>
                        <el-button
                            type="text"
                            ...
                            @click="showEditDialog('copy', scope.row)"
                        >
                            复制
                        </el-button>
                    </template>
