    ...
    <div class="app-container">
        <el-form inline>
            <el-form-item label="站点：">
                <el-select v-model="param.divisionId" clearable placeholder="请选择" size="medium">
            ...
            <el-form-item>
                ...
                <el-button size="medium" type="primary" icon="el-icon-plus" @click="showEditDialog('add')">
                    新增
                </el-button>
            </el-form-item>
        </el-form>
        <div class="main-content-wrapper">
            <el-table border height="100%" :data="dataList">
                ...
                <el-table-column label="ID" align="center" min-width="100px" prop="id"></el-table-column>
                <el-table-column label="站点" min-width="100px" header-align="center">
                ...
                <el-table-column fixed="right" label="操作" min-width="200px" align="center">
                    <template #default="scope">
                        ...
                        <el-button type="text" size="mini" @click="clickToDelete(scope.row)">删除</el-button>
                        <el-button type="text" size="mini" @click="toLinkGdOperatione(scope.row)">
                            商品管理
                        </el-button>
                    </template>
                </el-table-column>
