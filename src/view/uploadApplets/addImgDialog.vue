...
<template>
    <div class="add_account_dialog">
        <el-dialog v-model="dialogFormVisible" title="新增图片" size="medium" :before-close="closeDialog">
            <el-form :model="form" ref="form" :rules="formRule" :label-width="formLabelWidth">
                <el-form-item label="图片上传：">
                    <c-upload :limit="6" ref="cooperationImg" :fileList="form.imgUrl" @setDataImg="setCoverImg"></c-upload>
                </el-form-item>
            </el-form>
            <template #footer>
