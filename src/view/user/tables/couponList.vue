            ...
            <el-form inline ref="couponFilterForm" label-width="90px" :model="queryData">
                ...
                <span v-show="drop">
                    ...
                    <el-form-item label="使用状态：">
                        <el-select v-model="queryData.couponUseStatus" size="medium">
                            <!-- 与后端约定全部的时候传9值 -->
                            <el-option :value="9" label="全部"></el-option>
                            <el-option v-for="(val, key) in useStatus" :key="key" :label="val" :value="parseInt(key)"></el-option>
                        </el-select>
                    </el-form-item>
                </span>
...
export default {
    ...
    methods: {
        ...
        getUserCouponList() {
            this.loading = true;
            queryUserCouponManage({ query: this.filterData(Object.assign(this.queryData)) })
                .then(response => {
